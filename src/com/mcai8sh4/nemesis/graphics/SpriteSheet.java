...
public class SpriteSheet {
    ...
    public static SpriteSheet projectile_player = new SpriteSheet("/textures/Sheets/projectiles/player.png", 48);

    public static SpriteSheet player = new SpriteSheet("/textures/Sheets/player_sheet1.png", 96, 96);
    ...
    public static SpriteSheet dummy = new SpriteSheet("/textures/Sheets/King.png", 128, 96);
